...
[Google Antigravity](https://antigravity.google/) の使用感を確認する目的の簡易的なローカルアプリのため
**env, secret, 脆弱性対策** など未確認未対応です。
このリポジトリをプロダクトとして利用することは**非常に危険です**
ご注意ください
